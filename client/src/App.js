...
function App() {
  return (
   <div className="App" >
    <Routes>
      <Route exact path={Url.H_HOME} element ={<Home/>}/>
      <Route exact path="/DataDisplay" element ={<DataDisplay/>}/>
      <Route exact path="/reactdemo" element ={<ReactDemo/>}/>
      <Route exact path="/ForgotPass" element ={<ForgotPass/>}/>
      <Route exact path={Url.H_LOGIN} element ={<Login/>}/>
      <Route exact path={Url.H_REGISTER} element ={<Register/>}/>
      <Route exact path={Url.C_MAIN} element ={<CustomerMain/>}/>
      <Route exact path={Url.C_BILLPAY} element={<CustomerBillPay/>}/>
      <Route exact path={Url.C_ACCOUNT} element={<CustomerViewAccountList/>}/>
      <Route exact path={Url.C_VIEW} element={<CustomerViewAccountInformation/>}/>
      <Route exact path={Url.C_CREATE} element={<CustomerCreateAccount/>}/>
      <Route exact path="/customer" element={<CustomerViewUserInformation/>}/>
